...
CREATE TABLE helloProfiles (id INTEGER PRIMARY KEY,description VARCHAR(100),status INTEGER NOT NULL ,begintime TEXT,endtime TEXT,begindate TEXT,enddate TEXT);
INSERT INTO helloProfiles VALUES(1,'随时可用',2,'','','','');
INSERT INTO helloProfiles VALUES(2,'早上使用',1,'06','18','2017-09-06','2017-09-30');
COMMIT;
